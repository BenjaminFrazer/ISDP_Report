...
\label{sec:org340b22c}
\subsection{Background}
\label{sec:orgd6cae17}
...
\label{sec:org4b6455f}
\subsubsection{Platform}
\label{sec:org89f182b}
...
\bottomrule
\end{tabular}
\end{table}\footnotetext[2]{\label{org415190e}The battery memory effect is a reduction in the longevity of a rechargeable battery's charge, due to incomplete discharge in previous uses.}
...
\label{sec:org80cac83}
\subsubsection{Create brand value}
\label{sec:org02dd05d}
...
\label{sec:org429e4a7}
\subsection{Introduction}
\label{sec:org31ff4c2}
