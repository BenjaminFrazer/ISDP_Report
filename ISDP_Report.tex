...
\label{sec:orgfb814f4}
\subsection{Background}
\label{sec:orga779579}
...
\label{sec:org1ad5d4e}
\subsubsection{Platform}
\label{sec:org62ec928}
...
\bottomrule
\end{tabular}
\end{table}\footnotetext[2]{\label{org677dde8}The battery memory effect is a reduction in the longevity of a rechargeable battery's charge, due to incomplete discharge in previous uses.}
...
\label{sec:orgbc0e894}
\subsubsection{Create brand value}
\label{sec:org27b728a}
...
\label{sec:org0cd8d9c}
\subsection{Introduction}
\label{sec:org80b837a}
