...
** Cost
The project is projected to need an investment of about £7 million. A construction cost estimate was completed based on the data provided by the groups and actuals, and then annual maintenance costs were estimated based on partial actuals, using the payback formula to roughly calculate that it would take 7.89 years to complete the payback. Finally, the sources of revenue for the hotel are presented and some strategies are given to increase the revenue of the hotel, such as creating brand value/personality, marketing, etc., to accelerate the rate of return.
...
** Cost breakdown
The total fixed cost for power generation equipment is about 1,400,000£, including a 2MW wind turbine construction and installation fee. The operation and maintenance costs account for 1% of the total equipment costs, which is 14,000£.
...
As we can see in Figure ref:powerGenerationCost, the cost of offshore wind power generally ranges from 0.085£/kWh to 0.105£/kWh cite:&10.1016/j.ijepes.2021.107273. Here, we set 0.09£/kWh  as the unit cost. We assume that the resident population is 40 and each person consumes 4,500kWh electricity per year. It is necessary to generate an additional two months of electrical energy to store in case of temporary disability of power generating. Apart from the residents’ daily usage of electricity, floating villages’ basic operation activity, like mooring, stabilisation and so on, consumes 50,000kWh per year.   The yearly cost of generating power is [4,500kW 40(14 / 12) + 50,000kWh] 0.09£/kWh =23,400 £ per year.
...
:END:
** Storage Cost
The lifetime cost of small-scale battery storage is now around =13p/kWh= cite:&1234. Storing 1 kWh of power generation every day for =300= days of the year is worth about =£40=. At the moment the cost per kWh of storage (all-in installed cost) is about =£400=, and so the payback time for a system is around =10= years.
...
An =80kW= diesel generator costs =£15.000= cite:&123abc and consumes diesel =24 litres/hr= cite:&123bcd. The cost of diesel is around =150 p/litre= cite:&123cde and it’s =£315,360= for the whole year. The final price of power storage in floating village is
\(1500*£106 + £15000 + £315360=\)  =£490.000= including one year consumption of diesel.
...
#+caption: A novel platform of maritime communication network
...
CMCC (China Mobile Communications Group Co.,Ltd. is the world's leading communications company. The company can build communication lines, communication base stations and provide long-term maintenance.

*** Running cost analysis
Generally speaking, the cost of 5G Acer station is composed of main equipment, power supporting equipment and facilities and civil construction seen as ref:MainEquipment, ref:PowerSupportingEquipmentAndFacilities, ref:CivilConstruction.
...
** 4.5 Strategies for increasing revenue
*** 4.5.1  Create brand value
...
** 5.5  Overall Environmental Impact
...
* Conclusion
As an effective solution to the problem of sea level rise, the report discusses the structural, environmental, transport and cost aspects of sea villages, systematically demonstrating the integrity and feasibility of the project. It discusses possible solutions of different challenges, and chooses the best option.
In terms of structure, it focuses on describing what technology is used to achieve floating, and considers how to achieve the stability of the structure on the sea. In terms of electricity, how to solve the power supply problem of the project. In terms of cost, the cost of different parts of the project is listed. In terms of transportation and transportation, it discusses how to realise the connection between the village and the land and the connection between the villages, provide as many details of the project as possible, and also explain the market prospects and commercial purposes of the project, indicating its existence and business value.
